sap.ui.define(["sap/ui/core/mvc/Controller",
  ...
  return Controller.extend("zprelimdoc.controller.Doc", {
    ...
    onInit : function () {
      ...
      var oMetaModel = new sap.ui.model.odata.v2.ODataModel("/sap/opu/odata/SAP/ZPRELIMDOC_META_SRV");
...
//                     new sap.ui.model.Filter("Posnr", sap.ui.model.FilterOperator.EQ, that.Posnr)],
    ...
    setCheckFilters : function(){
      ...
      aFilters.push(new sap.ui.model.Filter("DcSelected", sap.ui.model.FilterOperator.EQ, "X"));
    ...
    OnListItemPressed : function(oSrc) {
      ...
      var oModelItem = oModel.getObject(oItem.getBindingContext("DocList").getPath());
...
//              });
    ...
    onTemplate : function (oParams) {
      ...
      if (!that.oTmplDialog) {
        ...
        that.oTmplDialog = sap.ui.xmlfragment(oView.getId(), "zprelimdoc.view.Template", that);
      ...
      this.getView().byId("listTemplates").columns = [new sap.m.Column(), new sap.m.Column()];
